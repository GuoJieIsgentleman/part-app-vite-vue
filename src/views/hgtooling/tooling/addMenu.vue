      ...
      <el-form :model="state.ruleForm" size="small" label-width="80px" ref="refform">
        <el-row :gutter="10">
          <el-form-item label="备件图片">
            <el-col :span="12">
              <el-upload class="avatar-uploader" ref="upload1" :on-change="imgpreivew" :auto-upload="false" :action="'https://www.ssxyf.cn:5556/hg_ToolingUploadfile?imgid=' +
                state.ruleForm.id +
                '&&time1=' +
