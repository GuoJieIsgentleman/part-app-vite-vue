...
export default {
  setup() {
    ...
    //确认提交
    const initmachine_equipment_rectification: any = inject(
      "initmachine_equipment_rectification"
    );
    const onSubmit = (v: any) => {
      ...
      if (v == "") {
        ...
        state.partsdetail.selectOption == ""
      ) {
        ElMessage.warning({
          message: "信息未确认",
          type: "warning",
        ...
        let res = service
          .get("/updatemachine_equipment_rectification", {
            params: {
              //保养列表的id 不是parts 的id
