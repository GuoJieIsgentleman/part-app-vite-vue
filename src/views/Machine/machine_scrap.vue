  ...
  <div class="system-menu-container">
    <el-card shadow="hover">
      ...
      <el-table id="outTable" v-loading="state.loading" :data="state.partslist" border stripe align="center" heigth="300"
        ...
        <el-table-column prop="applyformconfirm" label="报废表申请人员" width="140" align="center">
          <template #default="scope">
            <el-button type="success" :disabled="scope.row.applyformconfirm == '' ? false : true"
        ...
        <el-table-column prop="applyformconfirmdate" label="报废申请时间" align="center" width="140">
        </el-table-column>
        <el-table-column prop="scrapconfirm" label="报废件确认人员" width="140" align="center">
          <template #default="scope">
            <el-button type="success" :disabled="scope.row.scrapconfirm == '' ? false : true"
        ...
        <el-table-column prop="scrapconfirmdate" label="报废件确认时间" width="140" align="center">
        </el-table-column>

        <el-table-column prop="applicantman" label="补件申请人" width="140" align="center">
          <template #default="scope">
            <el-button type="success" :disabled="scope.row.applicantman == '' ? false : true"
        ...
        <el-table-column prop="applicantdate" min-width="140" align="center" label="申请补件时间">
        </el-table-column>
        ...
        <el-table-column prop="useconfirm" label="到件确认人员" min-width="140" align="center">
          <template #default="scope">
            <el-button type="success" :disabled="scope.row.useconfirm == '' ? false : true"
...
import Applyconfirm from "./components/machine_scrap/machine_sapplyconfirm.vue";

import Scarpconfirm from "./components/machine_scrap/machine_scarpconfirm.vue";

import Scarpapplyconfirm from "./components/machine_scrap/machine_scarpapplyconfirm.vue";

import Scarpuseconfirm from "./components/machine_scrap/machine_scarpuseconfirm.vue";
import Confirm from "./components/machine_scrap/sconfirm.vue";
...
const initscrap = async (flag?: any) => {
  let { data: res } = await service.get("/getmachine_scrap", {
    params: {
      flag: flag,
    },
  });
