...
import AddmaintenanceRecored from "/@/views/Machine/components/machine_maintenance/addmaintenanceRecored.vue";

import Maintenanceconfirm from "/@/views/Machine/components/machine_maintenance/maintenanceconfirm.vue";
import Confirm from "/@/views/Machine/components/machine_maintenance/mconfirm.vue";
...
//初始化领用记录
const initmachine_maintenance = async (flag?: any) => {
  let { data: res } = await service.get("/getmachine_maintenance", {
    params: {
      flag: flag,
    },
  });
...
provide("initmachine_maintenance", initmachine_maintenance);
onMounted(initmachine_maintenance);
...
const getuse = () => {
  //未确认记录
  initmachine_maintenance("noconfirm");
};

const getalluse = () => {
  //所有记录
  initmachine_maintenance("all");
};
