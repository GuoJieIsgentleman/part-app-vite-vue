    ...
    <el-card shadow="hover">
      ...
      <el-row :gutter="35">
        <el-col :span="12" :xs="12" :sm="12" :md="12" :lg="6" :xl="6">
          <Auths :value="['btn.machine_add']">
            <el-button @click="onOpenAddMenu()" type="success">添加机械备件</el-button>
          </Auths>
        </el-col>
...
const getspesc = async (value?: any) => {
  ...
  let { data: type } = await service.get("/getmachine_spesc", {
    params: {
