...
// import Applyconfirm from "./components/machine_equipment_rectification/machine_sapplyconfirm.vue";

// import Scarpconfirm from "./components/machine_equipment_rectification/machine_scarpconfirm.vue";

// import Scarpapplyconfirm from "./components/machine_equipment_rectification/machine_scarpapplyconfirm.vue";

import Scarpuseconfirm from "./components/machine_equipment_rectification/machine_equipment_rectification_confirm.vue";
...
const initmachine_equipment_rectification = async (flag?: any) => {
  let { data: res } = await service.get("/getmachine_equipment_rectification", {
    params: {
      flag: flag,
    },
  });
...
provide("initmachine_equipment_rectification", initmachine_equipment_rectification);
onMounted(initmachine_equipment_rectification);
const getuse = () => {
  //未确认记录
  initmachine_equipment_rectification("noconfirm");
};

const getalluse = () => {
  //所有记录
  initmachine_equipment_rectification("all");
};
...
const find = () => {
  ...
  service
    .get("/getmachine_equipment_rectification", {
      params: {
        flag1: "筛选查询",
        start: state.start,
        end: state.end,
