<template>
  <div class="system-menu-container">
    <el-dialog title="工装明细添加" v-model="state.isShowDialog" width="769px">
        ...
        <el-row :gutter="35">
          ...
          <el-col class="mb20" :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <el-form-item label="搁置区域">
              ...
              <el-input v-model="state.ruleForm.part_area_value"></el-input>
            </el-form-item>
          </el-col>
          <el-col class="mb20" :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
