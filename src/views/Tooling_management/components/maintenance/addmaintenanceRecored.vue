<template>
  <div class="system-menu-container">
    <el-dialog
      ...
      @close="closeDialog"
    >
      <el-form :model="ruleForm" ref="ruleform" size="small" label-width="80px">
        <el-row :gutter="35">
  ...
  setup() {
    ...
    const onSubmit = () => {
      ...
      if (
        ...
        ElMessage({ type: "warning", message: "请检查各个选项并填写" });
      } else {
        state.issave = !state.issave;
        //提交 保存  做非空验证
        let res = service
          .get("/addtooling_maintenance", {
            params: {
