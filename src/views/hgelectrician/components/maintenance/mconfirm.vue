...
import { getElectronArea, getElectronBalance, ListItem, typeOption } from "/@/hooks/getHgInfo";
...
const getbalance = async () => {
  ...
  let temp = await getElectronBalance(state.partsdetail.use_area, state.partsdetail.type, state.partsdetail.spec, state.partsdetail.use_part_name)
...
const openDialog = async (row?: any) => {
  ...
  getbalance()
  //获取产线
  state.ruleForm.areaArr = await getElectronArea()
