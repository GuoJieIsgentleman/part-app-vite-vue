          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
            <el-form-item label="备件图片">
              <div v-if="state.ruleForm.imgsrc">
                <!-- http://116.132.45.150:6900/ -->
                <el-upload class="avatar-uploader" :multiple="false" ref="upload" :auto-upload="true" :action="'http://116.132.45.150:6900/hg_uploadfile?imgid=' +
                  state.ruleForm.id +
                  '&&time1=' +
              ...
              <div v-else>
                <el-upload class="avatar-uploader" :multiple="false" :action="'http://116.132.45.150:6900/hg_uploadfile?imgid=' +
                  state.ruleForm.id +
                  '&&time1=' +
                  new Date().getTime().toString()
...
const getusearea = async () => {
  ...
  let { data: res } = await service.get("/hg_getusearea");
