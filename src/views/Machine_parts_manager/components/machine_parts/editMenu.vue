            ...
            <el-form-item label="备件图片">
              <div v-if="state.ruleForm.imgsrc != ''">
                ...
                <el-upload class="avatar-uploader" multiple="false" ref="upload" :action="
                  'https://61.185.74.251:5556/uploadfile?imgid=' +
                  state.ruleForm.id +
                  '&&time1=' +
        ...
        <el-row :gutter="35">
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
            <el-form-item label="类型">
              <el-input disabled v-model="state.ruleForm.type" placeholder="" clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
            <el-form-item label="备件名称">
              <el-input disabled v-model="state.ruleForm.part_name" placeholder="" clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
            <el-form-item label="备件型号">
              <el-input disabled v-model="state.ruleForm.part_spec" placeholder="" clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
            <el-form-item label="搁置区域">
              <el-select v-model="state.ruleForm.area" filterable placeholder="备件区域" clearable>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
            <el-form-item label="结存">
              <el-input v-model="state.ruleForm.balance" :placeholder="state.ruleForm.balance" clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
