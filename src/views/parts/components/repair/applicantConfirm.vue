    ...
    >
      <el-form :model="ruleForm" size="small" label-width="80px">
        <el-row :gutter="35">
          ...
          <!-- <el-col class="mb20" :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <el-form-item label="前搁置区域">
              <el-select v-model="ruleForm.area" placeholder="前搁置区域">
                <el-option
          ...
          <el-col class="mb20" :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <el-form-item label="确认人">
              <el-input v-model="ruleForm.name" placeholder="申请人" clearable></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
