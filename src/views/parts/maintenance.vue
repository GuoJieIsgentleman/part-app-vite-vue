...
import AddmaintenanceRecored from "/@/views/parts/components/maintenance/addmaintenanceRecored.vue";

import Maintenanceconfirm from "/@/views/parts/components/maintenance/maintenanceconfirm.vue";
import Confirm from "/@/views/parts/components/maintenance/mconfirm.vue";
...
const initmaintenance = async (flag?: any) => {
  let { data: res } = await service.get("/getmaintenance", {
    params: {
      flag: flag,
    },
  });
