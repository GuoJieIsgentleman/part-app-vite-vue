...
export const formatDate111 = (date: any) => {
...
export const subtimehours = (date: any) => {




  if (date) {
    let date1 = (new Date().getTime() - new Date(date.replace(/-/g, '/')).getTime())



    let time = Math.floor(date1 / 1000 / 60 / 60)
...
export const subtimeminutes = (date: any) => {
  ...
  if (date) {
    ...
    let time = Math.floor(date1 / 1000 / 60)
    console.log('time')
    console.log(time)
...
export const subtimeminutes1 = (startdate: any, enddate: any) => {




  if (startdate && enddate) {
    let date1 = (new Date(enddate.replace(/-/g, '/')).getTime() - new Date(startdate.replace(/-/g, '/')).getTime())
